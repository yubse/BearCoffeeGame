    ...
    function initGame() {
        ...
        const UI_TEXT = {
            ...
            en: {
                ...
                qrHint: 'Hold to save. [B Back]',
                summonHint: 'All 3 items found. [A Summon]',
                summonNameTitle: 'Who awakened me?',
                summonNameDesc: 'Please leave your name.',
                summonNameHint: '[A Confirm]',
                summonChoiceTitle: 'The Coffee Spirit remembers your name',
                shareButton: 'Share',
                wallpaperButton: 'What?',
                wallpaperClaimed: 'Claimed',
                purchaseButton: 'Buy',
                summonChoiceHint: 'Left/Right: Choose  [A Confirm]  [B Close]',
                shareHint: 'Hold to save. [B Back]',
                ...
                cocoServe: () => `Coco here. Your order is ready!\nHow is it?`,
                orderJoin: ' and '
            }
        };
        ...
        const STORY_EN = {
            panpan_start: { text: "Hi! I'm Panpan.\nOrder at the bar.\n[A Continue]|Stairs: upper right.\nKitchen: upper left.\n[B Close]" },
            panny_start: { text: "Hi! I'm Panny.\nI'm decorating cakes.\n[A Continue]", choices: ["That croissant looks good.", "One pudding, please!"] },
            panny_croissant: { text: "Coco dreamed of flat bread!\nWe made one.\n[A Continue]|Find a seat.\nCoco will bring it over.\n[B Close]" },
            panny_pudding: { text: "Sure! Find a seat.\nCoco will bring it over.\n[B Close]" },
            popea_start: { text: "Hi! I'm Popea.\nWhat would you like?\n[A Continue]|I lost the coffee contest.\nFriends made this trophy.|Cooky brings our beans\nstraight from the forest.|Choose a roast with DoDo.\nHe's on the right.\n[B Close]" },
            cooky_start: { text: "I'm Cooky.\nThese beans are forest-fresh.\n[B Close]" },
            doudou_start: { text: "I'm DoDo. I grind the beans.\nPick a roast.\n[A Continue]", choices: ["Light: fruit and flowers.", "Medium: hazelnut.", "Dark: rich chocolate."] },
            doudou_light: { text: "Light roast: fine grind.\nNow find a seat.\n[B Close]" },
            doudou_medium: { text: "Medium roast: medium grind.\nNow find a seat.\n[B Close]" },
            doudou_dark: { text: "Dark roast: coarse grind.\nNow find a seat.\n[B Close]" },
            coco_wait: { text: "I'm Coco, your server.\nYour order is coming.\n[B Close]" },
            seat_empty: { text: "An empty table.\nYou need to order first.\n[B Close]" },
            seat_sit: { text: "You sit down.", choices: ["Wait patiently..."] },
            coco_serve: { choices: ["Pretty good!", "It's just okay."] },
            coco_good: { text: "Yes! You're today's lucky guest.\n[A Continue]|A Jennifer cupcake for you!\n[B Close]" },
            coco_bad: { text: "Oops. Something went wrong.\n[A Continue]|A cupcake for you.\nNext time will be better.\n[B Close]" },
            pangpang_start: { text: "PangPang is stuck in jelly!\n[A Continue]", choices: ["Save him!", "Leave him there."] },
            pangpang_save: { text: "I was... helping!\nThanks. Take this jelly.\n[B Close]" },
            pangpang_ignore: { text: "You walk away.\nPangPang keeps struggling.\n[B Close]" },
            pingping_start: { text: "Help! PangPang is stuck!\n[B Close]" },
            guest_start: { text: "Great balcony view.\nTake my photo?\n[A Continue]", choices: ["Sure!", "I'm not good at photos."] },
            guest_yes: { text: "(Click)\nGreat photo. Thank you!\n[B Close]" },
            guest_no: { text: "I'll show you.\n(Click) Great photo!\n[B Close]" },
            oliver_start: { text: "(Click)\nLovely place, right?\n[B Close]" },
            chef_start: { text: "Welcome to the kitchen.\nCroissants are ready.\n[B Close]" },
            helper_start: { text: "New beans arrived.\nTake them to DoDo?\n[A Continue]", choices: ["On the bread rack?", "By the sink?", "On the table?"] },
            helper_happy: { text: "Yes! Thank you.\n[B Close]" },
            helper_sad: { text: "Nope. Keep looking.\n[B Close]" },
            helper_desk: { text: "Nope. Keep looking.\n[B Close]" },
            lucy_start: { text: "Meow~\n[B Close]" },
            find_item_0: { text: "Dark crumbs on the bar.\nThey smell faintly of coffee.", choices: ["Ask Popea.", "Leave them."] },
            find_item_1: { text: "What's that smell?\nWarm coffee fills the air.", choices: ["Caramel and nuts.", "Let PinPin clean it."] },
            find_item_2: { text: "Are these the missing beans?", choices: ["Take them to DoDo.", "Ask again."] },
            leave_item: { text: "You leave it alone.\n[B Close]" },
            summon_god_dialogue_1: { text: "Coffee grounds glow\nin a dark corner.\n[A Continue]" },
            summon_god_dialogue_2: { text: "Not ordinary grounds.\nThey hold every failed brew." },
            summon_god_dialogue_3: { text: "Every careful brew leaves a wish.\nSteam gathers them." },
            summon_god_dialogue_4: { text: "I am the Coffee Spirit,\nborn from persistence." },
            summon_god_dialogue_5: { text: "Recipes are not enough.\nBelieve in the next cup." },
        ...
        function openShopLink() {
            if (state.isDialogue) hideDialogueOnly();
            state.keys = { up: false, down: false, left: false, right: false };
            const shopUrl = SHOP_LINKS.wechat;
